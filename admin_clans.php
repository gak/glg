...
htmlSubHeading("Clan Management");
echo htmlGetcontent("admin_clans");

$te = new TableEditor('clan', 'admin_clans.php');
$te->AddField('id', 'ID');
$te->AddField('name', 'Name', 'lte,edit,inputtext');
$te->AddField('url', 'URL', 'edit,inputtext');
